"""
Infrastructure Service - Standalone FastAPI app for infrastructure services
...
async def lifespan(app: FastAPI):
    ...
    client.close()
    logger.info("Infrastructure Service stopped")
...
app.include_router(kong_routes.router)
app.include_router(temporal_routes.router)
app.include_router(airbyte_routes.router)
app.include_router(kafka_routes.router)
app.include_router(metabase_routes.router)
