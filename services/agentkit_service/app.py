"""
AgentKit Service - Standalone FastAPI app for AgentKit agents and workflows
...
async def lifespan(app: FastAPI):
    ...
    logger.info("✅ AgentKit Service started")
    yield
    
    client.close()
    logger.info("AgentKit Service stopped")

service_type = ServiceType.AGENTKIT
app = FastAPI(
...
app.include_router(agentkit_routes.router)
