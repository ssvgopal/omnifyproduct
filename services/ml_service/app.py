"""
ML Service - Standalone FastAPI app for predictive intelligence and AI/ML
...
app.include_router(predictive_intelligence_routes.router)
app.include_router(ai_ml_enhancements_routes.router)
